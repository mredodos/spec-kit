...
/speckit.outline Real-time chat system with message history and user presence
...
/speckit.structure WebSocket for real-time messaging, PostgreSQL for history, Redis for presence
